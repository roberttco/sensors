...
boolean ConnectToWiFi(RtcData *rtcData)
{
  ...
  if((loops == 0) && ((rtcData != NULL) && (rtcData->valid & APVALID == APVALID)))
  {
  ...
  while ( wifiStatus != WL_CONNECTED )
  {
    ...
    if ( retries == 600 )
    {
      ...
      {
        DEBUG_PRINTLN( "No connection after 600 steps. WiFi connection failed, disabled WiFi and waiting for 10 seconds" );
      }
